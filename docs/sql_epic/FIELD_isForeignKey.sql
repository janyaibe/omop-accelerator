...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_epic.LOCATION fkTable 
...
FROM (
 ...
 FROM _exponent.omop_epic.CARE_SITE cdmTable
 LEFT JOIN 
 _exponent.omop_epic.CONCEPT fkTable
...
FROM (
 ...
 FROM _exponent.omop_epic.CONDITION_ERA cdmTable
 LEFT JOIN 
 _exponent.omop_epic.PERSON fkTable 
...
FROM (
 ...
 FROM _exponent.omop_epic.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_epic.PROVIDER fkTable 
...
FROM (
 ...
 FROM _exponent.omop_epic.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_epic.VISIT_DETAIL fkTable 
...
FROM (
 ...
 FROM _exponent.omop_epic.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_epic.VISIT_OCCURRENCE fkTable 
...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_epic.DOMAIN fkTable
...
FROM (
 ...
 FROM _exponent.omop_epic.EPISODE_EVENT cdmTable
 LEFT JOIN 
 _exponent.omop_epic.EPISODE fkTable 
...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_epic.CARE_SITE fkTable 
...
FROM (
 ...
 FROM _exponent.omop_epic.SOURCE_TO_CONCEPT_MAP cdmTable
 LEFT JOIN 
 _exponent.omop_epic.VOCABULARY fkTable
