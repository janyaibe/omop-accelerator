...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.CARE_SITE cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.CARE_SITE
) denominator
) cte
)
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.CDM_SOURCE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.COST cdmTable
 WHERE 
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.DOSE_ERA
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.DRUG_STRENGTH
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.EPISODE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.EPISODE_EVENT cdmTable
 WHERE 
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.FACT_RELATIONSHIP cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.FACT_RELATIONSHIP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.LOCATION cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.LOCATION
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.METADATA cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.METADATA
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.NOTE_NLP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.PAYER_PLAN_PERIOD
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_epic.PROVIDER cdmTable
 WHERE 
 (CASE WHEN CAST(cdmTable.CARE_SITE_ID AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
 OR (CASE WHEN CAST(cdmTable.CARE_SITE_ID AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 1 
 AND INSTR(CAST(ABS(cdmTable.CARE_SITE_ID) AS STRING),'.') != 0))
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.PROVIDER
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.SOURCE_TO_CONCEPT_MAP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_epic.SPECIMEN
) denominator
) cte
)
INSERT INTO northwell_dev.omop_epic_quality.dqdashboard_results
