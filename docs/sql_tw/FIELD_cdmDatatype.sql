...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.CARE_SITE cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.CARE_SITE
) denominator
) cte
)
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.CDM_SOURCE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.CONDITION_ERA
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.COST cdmTable
 WHERE 
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.DEVICE_EXPOSURE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.DRUG_ERA
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.DRUG_STRENGTH cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.DRUG_STRENGTH
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.EPISODE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.EPISODE_EVENT cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.EPISODE_EVENT
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.FACT_RELATIONSHIP cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.FACT_RELATIONSHIP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.LOCATION cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.LOCATION
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.METADATA cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.METADATA
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.NOTE_NLP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.OBSERVATION_PERIOD
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.PAYER_PLAN_PERIOD
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.PROCEDURE_OCCURRENCE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.PROVIDER cdmTable
 WHERE 
 (CASE WHEN CAST(cdmTable.CARE_SITE_ID AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
 OR (CASE WHEN CAST(cdmTable.CARE_SITE_ID AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 1 
 AND INSTR(CAST(ABS(cdmTable.CARE_SITE_ID) AS STRING),'.') != 0))
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.PROVIDER
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 cdmTable.* 
 FROM _exponent.omop_tw.SOURCE_TO_CONCEPT_MAP cdmTable
 WHERE 
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.SOURCE_TO_CONCEPT_MAP
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.SPECIMEN
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.VISIT_DETAIL
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
...
FROM (
 ...
 COUNT(*) AS num_rows
 FROM _exponent.omop_tw.VISIT_OCCURRENCE
) denominator
) cte
)
INSERT INTO northwell_dev.omop_tw_quality.dqdashboard_results
