...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_tw.LOCATION fkTable 
...
FROM (
 ...
 FROM _exponent.omop_tw.CARE_SITE cdmTable
 LEFT JOIN 
 _exponent.omop_tw.CONCEPT fkTable
...
FROM (
 ...
 FROM _exponent.omop_tw.CONDITION_ERA cdmTable
 LEFT JOIN 
 _exponent.omop_tw.PERSON fkTable 
...
FROM (
 ...
 FROM _exponent.omop_tw.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_tw.PROVIDER fkTable 
...
FROM (
 ...
 FROM _exponent.omop_tw.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_tw.VISIT_DETAIL fkTable 
...
FROM (
 ...
 FROM _exponent.omop_tw.CONDITION_OCCURRENCE cdmTable
 LEFT JOIN 
 _exponent.omop_tw.VISIT_OCCURRENCE fkTable 
...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_tw.DOMAIN fkTable
...
FROM (
 ...
 FROM _exponent.omop_tw.EPISODE_EVENT cdmTable
 LEFT JOIN 
 _exponent.omop_tw.EPISODE fkTable 
...
FROM (
 ...
 LEFT JOIN 
 _exponent.omop_tw.CARE_SITE fkTable 
...
FROM (
 ...
 FROM _exponent.omop_tw.SOURCE_TO_CONCEPT_MAP cdmTable
 LEFT JOIN 
 _exponent.omop_tw.VOCABULARY fkTable
