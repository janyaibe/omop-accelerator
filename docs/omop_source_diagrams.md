...
Person Mapping → Standardize patient identity → Map source IDs to OMOP person_id<br/><br/>
Domain Mapping → Determine data type → Route to appropriate OMOP table<br/><br/>
