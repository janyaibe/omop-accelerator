...
Source Data → Raw clinical inputs<br/><br/>
Person Mapping → Standardize patient identity<br/>→ Map source IDs to OMOP person_id<br/><br/>
Domain Mapping → Determine data type<br/>→ Route to appropriate OMOP table<br/><br/>
